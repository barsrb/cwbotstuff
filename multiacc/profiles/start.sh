...
screen -S cli2 -dm ./telegram-cli -p profile_2 --json -P 2002

screen -S cli3 -dm ./telegram-cli -p profile_3 --json -P 2003

screen -S cli4 -dm ./telegram-cli -p profile_4 --json -P 2004

screen -S cli5 -dm ./telegram-cli -p profile_5 --json -P 2005

screen -S cli6 -dm ./telegram-cli -p profile_6 --json -P 2006

screen -S cli7 -dm ./telegram-cli -p profile_7 --json -P 2007

screen -S cli8 -dm ./telegram-cli -p profile_8 --json -P 2008

screen -S cli9 -dm ./telegram-cli -p profile_9 --json -P 2009

screen -S cli10 -dm ./telegram-cli -p profile_10 --json -P 2010
